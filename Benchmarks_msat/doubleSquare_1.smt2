...
(declare-rel pred_0_synth_msat_1 (Int Int Int Int Int))
 (rule (=>  ( = (rel end 1) 0  ) (pred_0_synth_msat_1 z y x h end)))
(declare-rel pred_synth_msat_2 (Int Int Int Int Int))
 (rule (=>  ( <= 2 (rel z 1)  ) (pred_synth_msat_2 z y x h end)))
(declare-rel pred_synth_msat_3 (Int Int Int Int Int))
 (rule (=>  ( <= 1 (rel z 0)  ) (pred_synth_msat_3 z y x h end)))
(declare-rel pred_synth_msat_4 (Int Int Int Int Int))
 (rule (=>  ( <= 1 (rel z 1)  ) (pred_synth_msat_4 z y x h end)))
(declare-rel pred_0_synth_msat_5 (Int Int Int Int Int))
 (rule (=>  ( = (rel end 0) 0  ) (pred_0_synth_msat_5 z y x h end)))
(declare-rel pred_0_synth_msat_6 (Int Int Int Int Int))
 (rule (=>  ( =  ( +  ( * 2 (rel x 0)  )  ( +  ( * 2 (rel y 0)  )  ( +  ( *  ( - 2  ) (rel x 1)  )  ( *  ( - 1  ) (rel y 1)  )  )  )  ) 0  ) (pred_0_synth_msat_6 z y x h end)))
(declare-rel pred_0_synth_msat_7 (Int Int Int Int Int))
 (rule (=>  ( = 0  ( + (rel x 1)  ( + (rel y 1)  ( +  ( *  ( - 2  ) (rel y 0)  )  ( *  ( - 2  ) (rel x 0)  )  )  )  )  ) (pred_0_synth_msat_7 z y x h end)))
(declare-rel pred_0_synth_msat_8 (Int Int Int Int Int))
 (rule (=>  ( <= (rel y 0) (rel y 1)  ) (pred_0_synth_msat_8 z y x h end)))
(declare-rel pred_0_synth_msat_9 (Int Int Int Int Int))
 (rule (=>  ( = 0  ( + (rel y 1)  ( +  ( *  ( - 2  ) (rel y 0)  )  ( *  ( - 2  ) (rel x 0)  )  )  )  ) (pred_0_synth_msat_9 z y x h end)))
(declare-rel pred_0_synth_msat_10 (Int Int Int Int Int))
 (rule (=>  ( =  ( +  ( * 2 (rel z 0)  )  ( *  ( - 1  ) (rel z 1)  )  ) 0  ) (pred_0_synth_msat_10 z y x h end)))
(declare-rel pred_0_synth_msat_11 (Int Int Int Int Int))
 (rule (=>  ( =  ( + (rel z 1)  ( *  ( - 2  ) (rel z 0)  )  )  ( - 1  )  ) (pred_0_synth_msat_11 z y x h end)))
(query End)
