...
(declare-rel p_synth_13 (Int Int Int Int Int))
 (rule (=>   (and  (not  (<= (rel x 0) 0 ) )  (>= (rel y 1) 1 )  (or  (<=  (+  (*  (- 2 ) (rel x 0) ) (rel y 1) )  (- 1 ) )  (<=  (+  (* 2 (rel x 0) )  (*  (- 1 ) (rel y 1) ) )  (- 1 ) ) )  (or  (<=  (+  (*  (- 1 ) (rel x 0) ) (rel y 1) )  (- 1 ) )  (<=  (+ (rel x 0)  (*  (- 1 ) (rel y 1) ) )  (- 1 ) ) ) ) (p_synth_13 z y x h end)))
(declare-rel p_synth_14 (Int Int Int Int Int))
 (rule (=>   (and  (= (rel z 0) 1 )  (>= (rel y 1) 2 )  (=  (mod  (* 1 (rel y 1) ) 2 ) 0 ) ) (p_synth_14 z y x h end)))
(declare-rel p_synth_15 (Int Int Int Int Int))
 (rule (=>   (and  (= (rel z 0) 1 )  (=  (mod (rel x 0) 2 ) 0 )  (>= (rel x 0) 2 ) )  (p_synth_15 z y x h end)))
(query End)
