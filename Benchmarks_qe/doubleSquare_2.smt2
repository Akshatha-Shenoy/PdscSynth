...
(declare-rel p_synth_3 (Int Int Int Int Int))
 (rule (=>   (and  (= (rel z 1)  (* 2 (rel z 0) ) ) (not  (<= (rel z 1) 0 ) ) (not  (= (rel z 0)  (+  (- 1 ) (rel z 1) ) ) ) (not  (= (rel z 0)  (+  (- 2 ) (rel z 1) ) ) ) ) (p_synth_3 z y x h end)))
(declare-rel p_synth_4 (Int Int Int Int Int))
 (rule (=>   (and  (>= (rel z 0) 0 ) (or  (<= (rel z 1) 1 ) (= (rel z 0)  (+  (- 2 ) (rel z 1) ) ) (=  (* 2 (rel z 0) )  (+  (- 2 ) (rel z 1) ) ) ) (not  (= (rel z 1)  (+ 1  (* 2 (rel z 0) ) ) ) ) (not  (= (rel z 1)  (* 2 (rel z 0) ) ) ) (not  (<= (rel z 1) 0 ) ) (not  (= (rel z 0) (rel z 1) ) ) ) (p_synth_4 z y x h end)))
...
(declare-rel p_synth_6 (Int Int Int Int Int))
 (rule (=>   (and  (<= (rel z 1) 0 )  (<=  (+  (*  (- 1 ) (rel z 0) ) (rel z 1) )  (- 1 ) )  (>= (rel z 1) 0 ) ) (p_synth_6 z y x h end)))
(declare-rel p_synth_7 (Int Int Int Int Int))
 (rule (=>   (and  (= (rel z 0) 0 )  (= (rel z 1)  (+ 1  (* 2 (rel z 0) ) ) ) ) (p_synth_7 z y x h end)))
(declare-rel p_synth_8 (Int Int Int Int Int))
 (rule (=>   (and  (= (rel z 0) 0 )  (= 0 (rel end 0) ) )  (p_synth_8 z y x h end)))
(declare-rel p_synth_9 (Int Int Int Int Int))
 (rule (=>   (and  (>= (rel y 0) 1 )  (>= (rel y 1) 0 )  (not  (= (rel y 0) (rel y 1) ) )  (not  (=  (* 2 (rel y 0) ) (rel y 1) ) ) ) (p_synth_9 z y x h end)))
(declare-rel p_synth_10 (Int Int Int Int Int))
 (rule (=>   (and  (= 1 (rel z 0) )  (<= (rel z 1) 0 )  (>= (rel z 1) 0 ) )  (p_synth_10 z y x h end)))
(declare-rel p_synth_11 (Int Int Int Int Int))
 (rule (=>   (and  (= 0 (rel end 0) )  (= (rel z 0) 1 ) )  (p_synth_11 z y x h end)))
(declare-rel p_synth_12 (Int Int Int Int Int))
 (rule (=>   (and  (not  (<= (rel x 0) 0 ) )  (>= (rel y 1) 1 )  (or  (<=  (+ (rel y 1)  (*  (- 1 ) (rel x 0) ) )  (- 1 ) )  (<=  (+  (*  (- 1 ) (rel y 1) ) (rel x 0) )  (- 1 ) ) )  (or  (<=  (+ (rel y 1)  (*  (- 2 ) (rel x 0) ) )  (- 1 ) )  (<=  (+  (*  (- 1 ) (rel y 1) )  (* 2 (rel x 0) ) )  (- 1 ) ) ) ) (p_synth_12 z y x h end)))
(declare-rel p_synth_13 (Int Int Int Int Int))
 (rule (=>   (and  (= (rel z 0) 1 )  (>= (rel y 1) 2 )  (=  (mod (rel y 1) 2 ) 0 ) )  (p_synth_13 z y x h end)))
(declare-rel p_synth_14 (Int Int Int Int Int))
 (rule (=>   (and  (= (rel z 0) 1 )  (=  (mod (rel x 0) 2 ) 0 )  (>= (rel x 0) 2 ) )  (p_synth_14 z y x h end)))
(query End)
