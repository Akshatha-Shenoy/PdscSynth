...
(declare-rel p_synth_13 (Int Int Int Int Int))
 (rule (=>   (and  (= (rel z 0)  (+  (- 1 ) (rel z 1) ) )  (not  (<= (rel z 0) 0 ) )  (<= (rel z 1) 2 ) )  (p_synth_13 z y x h end)))
(declare-rel p_synth_14 (Int Int Int Int Int))
 (rule (=>   (and  (not  (<= (rel z 0) 0 ) )  (= 0 (rel end 0) )  (<= (rel z 0) 1 ) )  (p_synth_14 z y x h end)))
(declare-rel p_synth_15 (Int Int Int Int Int))
 (rule (=>   (and  (not  (<= (rel z 0) 0 ) )  (<= (rel z 0) 1 )  (>= (rel y 0) 1 ) )  (p_synth_15 z y x h end)))
(query End)
