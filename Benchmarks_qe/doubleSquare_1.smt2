...
(declare-rel p_synth_17 (Int Int Int Int Int))
 (rule (=>   (and  (not  (<= (rel x 0) 0 ) )  (>= (rel y 1) 1 )  (or  (<=  (+ (rel y 1)  (*  (- 2 ) (rel x 0) ) )  (- 1 ) )  (<=  (+  (*  (- 1 ) (rel y 1) )  (* 2 (rel x 0) ) )  (- 1 ) ) )  (or  (<=  (+  (*  (- 1 ) (rel y 1) ) (rel x 0) )  (- 1 ) )  (<=  (+ (rel y 1)  (*  (- 1 ) (rel x 0) ) )  (- 1 ) ) ) ) (p_synth_17 z y x h end)))
(declare-rel p_synth_18 (Int Int Int Int Int))
 (rule (=>   (and  (<=  (+ (rel y 1)  (*  (- 2 ) (rel x 0) ) )  (- 1 ) )  (not  (<=  (+  (* (rel y 1)  (- 1 ) ) (rel x 0) )  (- 1 ) ) )  (not  (<=  (+ (rel y 1)  (* (rel x 0)  (- 1 ) ) )  (- 1 ) ) ) ) (p_synth_18 z y x h end)))
(query End)
