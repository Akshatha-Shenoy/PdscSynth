;;c_src (and (= 1 count_0) (= 43 x_0) (= 1 count_1) (= 1 h_1) (= 43 x_1) (= 1 h_0))
;;c_tgt (and (= 1 count_0) (= 43 x_0) (= 1 h_0) (= 1 count_1) (= 1 h_1) (= 43 x_1))
;;a_src (and (= x_0 x_1)(not (= x_1 8))(<= 42 x_1)(not (= x_1 42))(= h_0 1)(not (= count_0 0))(= h_1 1)(not (= count_1 0))) 
;;a_tgt (and (not (= x_0 x_1))(not (= x_1 8))(not (<= 42 x_1))(not (= x_1 42))(= h_0 1)(not (= count_0 0))(= h_1 1)(not (= count_1 0))) 
...
(define-fun c_src ((x_1 Int)(h_1 Int)(count_0 Int)(h_0 Int)(x_0 Int)(count_1 Int)) Bool (and (= 1 count_0) (= 43 x_0) (= 1 count_1) (= 1 h_1) (= 43 x_1) (= 1 h_0)))

(define-fun a_src ((x_1 Int)(h_1 Int)(count_0 Int)(h_0 Int)(x_0 Int)(count_1 Int)) Bool  (and (= x_0 x_1)(not (= x_1 8))(<= 42 x_1)(not (= x_1 42))(= h_0 1)(not (= count_0 0))(= h_1 1)(not (= count_1 0))) )

(define-fun a_tgt ((x_1 Int)(h_1 Int)(count_0 Int)(h_0 Int)(x_0 Int)(count_1 Int)) Bool  (and (not (= x_0 x_1))(not (= x_1 8))(not (<= 42 x_1))(not (= x_1 42))(= h_0 1)(not (= count_0 0))(= h_1 1)(not (= count_1 0))) )
