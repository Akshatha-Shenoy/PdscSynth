...
a=simplify(And(And(x0_eq_x1 == True,    p_synth_1 == False,    p_synth_2 == False,    p_synth_3 == False,    p_synth_4 == True,    p_synth_5 == True,    abs_h_0 == True,    count_0_0 == True,    abs_h_1 == True,    count_0_1 == False)))
print(a.sexpr())
