...
a=simplify(And(And(z0_eq_z1 == True,    y0_eq_y1 == False,    x0_eq_x1 == True,    x0_gt_0 == True,    p_synth_1 == False,    p_synth_2 == False,    p_synth_3 == True,    p_synth_9 == False,    p_synth_4 == False,    y_gteq_0_0 == True,    z_gteq_0_0 == True,    abs_end_0 == True,    abs_h_0 == False,    y_gteq_0_1 == True,    z_gteq_0_1 == True,    abs_end_1 == True,    abs_h_1 == True)))
print(a.sexpr())
