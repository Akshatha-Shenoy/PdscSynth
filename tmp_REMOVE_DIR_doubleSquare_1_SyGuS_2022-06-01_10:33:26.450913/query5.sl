;;c_src (and (= 1 y_0)(= 0 z_0)(= 0 end_0)(= 1 x_0)(= 1 end_1)(= 1 h_1)(= 1 x_1)(= 2 y_1)(= 0 z_1)(= 0 h_0))
;;c_tgt (and (= 2 y_0)(= 0 z_0)(= 1 end_0)(= 1 x_0)(= 1 end_1)(= 1 h_1)(= 1 x_1)(= 2 y_1)(= 0 z_1)(= 0 h_0))
;;a_src (and (= z_0 z_1)(not (= y_0 y_1))(= x_0 x_1)(not (<= x_0 0))(<= z_1 x_1)(not (= x_1 z_0))(= x_1 h_1)(not (= h_1 z_1))(not (= (* 2 x_1) z_1))(>= y_0 0)(>= z_0 0)(not (= end_0 1))(not (= h_0 1))(>= y_1 0)(>= z_1 0)(= end_1 1)(= h_1 1)) 
;;a_tgt (and (= z_0 z_1)(not (= y_0 y_1))(= x_0 x_1)(not (<= x_0 0))(<= z_1 x_1)(not (= x_1 z_0))(= x_1 h_1)(not (= h_1 z_1))(not (= (* 2 x_1) z_1))(>= y_0 0)(>= z_0 0)(= end_0 1)(not (= h_0 1))(>= y_1 0)(>= z_1 0)(= end_1 1)(= h_1 1)) 
...
(define-fun c_src ((x_1 Int)(h_1 Int)(h_0 Int)(x_0 Int)(end_0 Int)(z_0 Int)(y_0 Int)(y_1 Int)(z_1 Int)(end_1 Int)) Bool (and (= 1 y_0)(= 0 z_0)(= 0 end_0)(= 1 x_0)(= 1 end_1)(= 1 h_1)(= 1 x_1)(= 2 y_1)(= 0 z_1)(= 0 h_0)))

(define-fun a_src ((x_1 Int)(h_1 Int)(h_0 Int)(x_0 Int)(end_0 Int)(z_0 Int)(y_0 Int)(y_1 Int)(z_1 Int)(end_1 Int)) Bool  (and (= z_0 z_1)(not (= y_0 y_1))(= x_0 x_1)(not (<= x_0 0))(<= z_1 x_1)(not (= x_1 z_0))(= x_1 h_1)(not (= h_1 z_1))(not (= (* 2 x_1) z_1))(>= y_0 0)(>= z_0 0)(not (= end_0 1))(not (= h_0 1))(>= y_1 0)(>= z_1 0)(= end_1 1)(= h_1 1)) )

(define-fun a_tgt ((x_1 Int)(h_1 Int)(h_0 Int)(x_0 Int)(end_0 Int)(z_0 Int)(y_0 Int)(y_1 Int)(z_1 Int)(end_1 Int)) Bool  (and (= z_0 z_1)(not (= y_0 y_1))(= x_0 x_1)(not (<= x_0 0))(<= z_1 x_1)(not (= x_1 z_0))(= x_1 h_1)(not (= h_1 z_1))(not (= (* 2 x_1) z_1))(>= y_0 0)(>= z_0 0)(= end_0 1)(not (= h_0 1))(>= y_1 0)(>= z_1 0)(= end_1 1)(= h_1 1)) )
