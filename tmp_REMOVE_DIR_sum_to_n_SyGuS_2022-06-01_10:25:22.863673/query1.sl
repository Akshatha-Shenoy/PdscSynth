;;c_src (and (= 1 i_1) (= 0 sum_1) (= 0 sum_0) (= 1 n_0) (= 0 i_0) (= 1 n_1))
;;c_tgt (and (= 1 i_0) (= 0 sum_0) (= 0 sum_1) (= 1 n_1) (= 1 i_1) (= 1 n_0))
;;a_src (and (= i_0 0)(not (= i_1 0))(= sum_0 sum_1)(= n_0 n_1)(not (= i_0 n_0))(not (<= n_0 i_0))(not (<= n_0 0))(= i_1 n_1)(<= n_1 i_1)(not (<= n_1 0))) 
;;a_tgt (and (not (= i_0 0))(not (= i_1 0))(= sum_0 sum_1)(= n_0 n_1)(not (= i_0 n_0))(not (<= n_0 i_0))(not (<= n_0 0))(= i_1 n_1)(<= n_1 i_1)(not (<= n_1 0))) 
...
(define-fun c_src ((n_0 Int)(sum_0 Int)(sum_1 Int)(i_1 Int)(i_0 Int)(n_1 Int)) Bool (and (= 1 i_1) (= 0 sum_1) (= 0 sum_0) (= 1 n_0) (= 0 i_0) (= 1 n_1)))

(define-fun a_src ((n_0 Int)(sum_0 Int)(sum_1 Int)(i_1 Int)(i_0 Int)(n_1 Int)) Bool  (and (= i_0 0)(not (= i_1 0))(= sum_0 sum_1)(= n_0 n_1)(not (= i_0 n_0))(not (<= n_0 i_0))(not (<= n_0 0))(= i_1 n_1)(<= n_1 i_1)(not (<= n_1 0))) )

(define-fun a_tgt ((n_0 Int)(sum_0 Int)(sum_1 Int)(i_1 Int)(i_0 Int)(n_1 Int)) Bool  (and (not (= i_0 0))(not (= i_1 0))(= sum_0 sum_1)(= n_0 n_1)(not (= i_0 n_0))(not (<= n_0 i_0))(not (<= n_0 0))(= i_1 n_1)(<= n_1 i_1)(not (<= n_1 0))) )
