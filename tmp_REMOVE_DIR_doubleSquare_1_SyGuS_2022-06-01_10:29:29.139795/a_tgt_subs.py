...
a=simplify(And(And(And(z0_eq_z1p == False,        y0_eq_y1p == True,        x0_eq_x1p == True,        x0_gt_0p == True,        p_synth_1p == False,        p_synth_2p == True,        p_synth_3p == True,        p_synth_4p == False,        y_gteq_0_0p == True,        z_gteq_0_0p == True,        abs_end_0p == False,        abs_h_0p == False,        y_gteq_0_1p == True,        z_gteq_0_1p == True,        abs_end_1p == False,        abs_h_1p == True))))
print(a.sexpr())
