...
;;a_src (and (not (= z_0 z_1))(not (= y_0 y_1))(= x_0 x_1)(not (<= x_0 0))(<= z_1 x_1)(= x_1 z_0)(>= y_0 0)(>= z_0 0)(not (= end_0 1))(not (= h_0 1))(>= y_1 0)(>= z_1 0)(= end_1 1)(= h_1 1)) 
;;a_tgt (and (not (= z_0 z_1))(not (= y_0 y_1))(= x_0 x_1)(not (<= x_0 0))(<= z_1 x_1)(not (= x_1 z_0))(>= y_0 0)(>= z_0 0)(not (= end_0 1))(not (= h_0 1))(>= y_1 0)(>= z_1 0)(= end_1 1)(= h_1 1)) 
...
(define-fun a_src ((x_1 Int)(h_1 Int)(h_0 Int)(x_0 Int)(end_0 Int)(z_0 Int)(y_0 Int)(y_1 Int)(z_1 Int)(end_1 Int)) Bool  (and (not (= z_0 z_1))(not (= y_0 y_1))(= x_0 x_1)(not (<= x_0 0))(<= z_1 x_1)(= x_1 z_0)(>= y_0 0)(>= z_0 0)(not (= end_0 1))(not (= h_0 1))(>= y_1 0)(>= z_1 0)(= end_1 1)(= h_1 1)) )

(define-fun a_tgt ((x_1 Int)(h_1 Int)(h_0 Int)(x_0 Int)(end_0 Int)(z_0 Int)(y_0 Int)(y_1 Int)(z_1 Int)(end_1 Int)) Bool  (and (not (= z_0 z_1))(not (= y_0 y_1))(= x_0 x_1)(not (<= x_0 0))(<= z_1 x_1)(not (= x_1 z_0))(>= y_0 0)(>= z_0 0)(not (= end_0 1))(not (= h_0 1))(>= y_1 0)(>= z_1 0)(= end_1 1)(= h_1 1)) )
