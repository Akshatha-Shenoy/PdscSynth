...
(declare-rel p_synth_2 (Int Int Int Int Int))
 (rule (=>   (and  (<= (rel z 1) 0 )  (>= (rel z 0) 0 )  (=  (+ (rel z 0)  (*  (- 1 ) (rel z 1) ) ) 0 ) ) (p_synth_2 z y x h end)))
...
(declare-rel p_synth_5 (Int Int Int Int Int))
 (rule (=>   (and  (<= (rel z 1) 3 )  (>= (rel z 0) 0 )  (<= (rel z 0) 0 )  (not  (<= (rel z 1) 2 ) ) )  (p_synth_5 z y x h end)))
(declare-rel p_synth_6 (Int Int Int Int Int))
 (rule (=>   (and  (<= (rel z 1) 1 )  (not  (<= (rel z 1) 0 ) )  (not  (<= (rel z 0) 0 ) )  (not  (= (rel z 0) (rel z 1) ) ) )  (p_synth_6 z y x h end)))
...
(declare-rel p_synth_9 (Int Int Int Int Int))
 (rule (=>   (and  (= (rel z 1)  (+  (- 1 ) (rel z 0) ) )  (<= (rel z 1) 0 )  (>= (rel z 1) 0 ) )  (p_synth_9 z y x h end)))
(declare-rel p_synth_10 (Int Int Int Int Int))
 (rule (=>   (and  (= 0 (rel end 0) )  (<= (rel z 0) 1 )  (not  (<= (rel z 0) 0 ) ) )  (p_synth_10 z y x h end)))
(declare-rel p_synth_11 (Int Int Int Int Int))
 (rule (=>   (and  (<= (rel z 1) 6 )  (<= (rel z 0) 0 )  (not  (<= (rel z 1) 5 ) )  (>= (rel z 0) 0 ) )  (p_synth_11 z y x h end)))
(query End)
