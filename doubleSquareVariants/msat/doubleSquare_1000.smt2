...
(declare-rel pred_0_synth_msat_3 (Int Int Int Int Int))
 (rule (=>  ( =  ( +  ( * 2 (rel x 0)  )  ( +  ( * 2 (rel y 0)  )  ( +  ( *  ( - 2  ) (rel x 1)  )  ( *  ( - 1  ) (rel y 1)  )  )  )  ) 0  ) (pred_0_synth_msat_3 z y x h end)))
...
(declare-rel pred_0_synth_msat_6 (Int Int Int Int Int))
 (rule (=>  ( = 0  ( + (rel x 1)  ( + (rel y 1)  ( +  ( *  ( - 2  ) (rel y 0)  )  ( *  ( - 2  ) (rel x 0)  )  )  )  )  ) (pred_0_synth_msat_6 z y x h end)))
(declare-rel pred_0_synth_msat_7 (Int Int Int Int Int))
 (rule (=>  ( = 0  ( + (rel y 1)  ( +  ( *  ( - 2  ) (rel y 0)  )  ( *  ( - 2  ) (rel x 0)  )  )  )  ) (pred_0_synth_msat_7 z y x h end)))
