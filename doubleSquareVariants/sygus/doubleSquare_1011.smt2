...
(declare-rel p_synth_2 (Int Int Int Int Int))
 (rule (=>  (= (rel h 1)  (- (rel z 1) (rel z 0))) (p_synth_2 z y x h end)))
(declare-rel p_synth_3 (Int Int Int Int Int))
 (rule (=>  (= (rel h 1)  (- (rel z 0) (rel h 1))) (p_synth_3 z y x h end)))
(declare-rel p_synth_4 (Int Int Int Int Int))
 (rule (=>  (= (rel h 1)  (- (rel z 1)  (+ (rel h 1) (rel z 0)))) (p_synth_4 z y x h end)))
(declare-rel p_synth_5 (Int Int Int Int Int))
 (rule (=>  (= (rel z 0) 3 ) (p_synth_5 z y x h end)))
(declare-rel p_synth_6 (Int Int Int Int Int))
 (rule (=>  (= (rel z 0)  (- (rel z 1) 3 )) (p_synth_6 z y x h end)))
(declare-rel p_synth_7 (Int Int Int Int Int))
 (rule (=>  (= (rel z 0) 4 ) (p_synth_7 z y x h end)))
(declare-rel p_synth_8 (Int Int Int Int Int))
 (rule (=>  (= (rel z 0)  (- (rel z 1) 4 )) (p_synth_8 z y x h end)))
(declare-rel p_synth_9 (Int Int Int Int Int))
 (rule (=>  (= (rel z 0) 5 ) (p_synth_9 z y x h end)))
(declare-rel p_synth_10 (Int Int Int Int Int))
 (rule (=>  (= (rel z 0)  (- (rel z 1) 5 )) (p_synth_10 z y x h end)))
(declare-rel p_synth_11 (Int Int Int Int Int))
 (rule (=>  (= (rel z 0) 6 ) (p_synth_11 z y x h end)))
(declare-rel p_synth_12 (Int Int Int Int Int))
 (rule (=>  (= (rel z 0)  (- (rel z 1) 6 )) (p_synth_12 z y x h end)))
(declare-rel p_synth_13 (Int Int Int Int Int))
 (rule (=>  (= (rel z 0) 7 ) (p_synth_13 z y x h end)))
(declare-rel p_synth_14 (Int Int Int Int Int))
 (rule (=>  (= (rel z 0)  (- (rel z 1) 7 )) (p_synth_14 z y x h end)))
(query End)
