...
(define-fun A_0 () Bool  (and (= 0 count_0) (= 0 count_1) (= x_0 x_1) (= h_0 1) (= h_1 1)) )
...
(define-fun A_3() Bool      ( and ( not ( = xpp_0 xpp_1 ) ) ( = countpp_1 1 ) ( not ( = xpp_1 1 ) ) ( = countpp_0 1 ) ( not ( = xpp_0 1009 ) ) ( not ( = xpp_1 8 ) ) ( not ( = xpp_1 1009 ) ) ( not ( = xpp_0 383 ) ) ( = hpp_0 1 ) ( not ( = countpp_0 0 ) ) ( = hpp_1 1 ) ( not ( = countpp_1 0 ) ) ))
