...
(define-fun A_8() Bool      ( and ( = zppppppp_0 zppppppp_1 ) ( not ( = yppppppp_0 yppppppp_1 ) ) ( = xppppppp_0 xppppppp_1 ) ( not ( <= xppppppp_0 0 ) ) ( = zppppppp_1 ( * 2 zppppppp_0 ) ) ( not ( >= zppppppp_0 1 ) ) ( not ( = endppppppp_1 0 ) ) ( not ( = ( + ( * 2 xppppppp_0 ) ( * 2 yppppppp_0 ) ( * ( - 2 ) xppppppp_1 ) ( * ( - 1 ) yppppppp_1 ) ) 0 ) ) ( not ( >= zppppppp_1 2 ) ) ( not ( = endppppppp_0 0 ) ) ( not ( = ( + xppppppp_1 yppppppp_1 ( * ( - 2 ) yppppppp_0 ) ( * ( - 2 ) xppppppp_0 ) ) 0 ) ) ( not ( = ( + yppppppp_1 ( * ( - 2 ) yppppppp_0 ) ( * ( - 2 ) xppppppp_0 ) ) 0 ) ) ( not ( <= yppppppp_0 yppppppp_1 ) ) ( not ( = ( + ( * 2 yppppppp_0 ) ( * ( - 1 ) yppppppp_1 ) ) 0 ) ) ( >= yppppppp_0 0 ) ( >= zppppppp_0 0 ) ( = endppppppp_0 1 ) ( not ( = hppppppp_0 1 ) ) ( >= yppppppp_1 0 ) ( >= zppppppp_1 0 ) ( = endppppppp_1 1 ) ( = hppppppp_1 1 ) ))
