...
(define-fun A_6() Bool      ( and ( = nppppp_0 nppppp_1 ) ( not ( = ctppppp_0 ctppppp_1 ) ) ( = nppppp_0 0 ) ( not ( <= ctppppp_1 0 ) ) ( not ( <= nppppp_0 ( - 1 ) ) ) ( not ( <= ctppppp_1 1 ) ) ( not ( and ( not ( <= nppppp_0 ( - 1 ) ) ) ( not ( = nppppp_0 0 ) ) ( not ( = nppppp_0 ( div nppppp_1 10 ) ) ) ( not ( = nppppp_0 nppppp_1 ) ) ( not ( = nppppp_1 0 ) ) ) ) ( not ( and ( = nppppp_0 nppppp_1 ) ( not ( <= nppppp_0 ( - 1 ) ) ) ( not ( = ( div nppppp_1 10 ) 0 ) ) ) ) ( not ( and ( = ( div nppppp_0 10 ) 0 ) ( = nppppp_1 0 ) ( <= ( + nppppp_1 ( * ( - 1 ) nppppp_0 ) ) ( - 1 ) ) ) ) ( = hppppp_0 1 ) ( = endppppp_0 1 ) ( not ( = ctppppp_0 0 ) ) ( = ctppppp_0 1 ) ( not ( = hppppp_1 1 ) ) ( = endppppp_1 1 ) ( not ( = ctppppp_1 0 ) ) ( not ( = ctppppp_1 1 ) ) ))
