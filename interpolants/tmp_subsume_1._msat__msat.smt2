...
(define-fun A_1 () Bool  (and (or (and true (= h_1 hp_1) (ite (= 1 h_1) (ite (= 0 (mod x_1 7))                 (and (= xp_1 8) (= countp_1 1))                 (ite (= x_1 1009)                      (and (= xp_1 1) (= countp_1 1))                      (and (= xp_1 x_1) (= countp_1 1)))) (ite (= 0 (mod x_1 7))                 (and (= xp_1 8) (= countp_1 1))                 (and (= xp_1 (mod x_1 7)) (= countp_1 1)))))                (and (= x_1 xp_1)                     (= h_1 hp_1)                     (= count_1 countp_1)                     true                     (= 1 count_1))) (= x_0 xp_0) (= h_0 hp_0) (= count_0 countp_0))) 
(define-fun A_2 () Bool   ( and ( or ( and true ( = hp_0 hpp_0 ) ( ite ( = 1 hp_0 ) ( ite ( = 0 ( mod xp_0 7 ) ) ( and ( = xpp_0 8 ) ( = countpp_0 1 ) ) ( ite ( = xp_0 1009 ) ( and ( = xpp_0 1 ) ( = countpp_0 1 ) ) ( and ( = xpp_0 xp_0 ) ( = countpp_0 1 ) ) ) ) ( ite ( = 0 ( mod xp_0 7 ) ) ( and ( = xpp_0 8 ) ( = countpp_0 1 ) ) ( and ( = xpp_0 ( mod xp_0 7 ) ) ( = countpp_0 1 ) ) ) ) ) ( and ( = xp_0 xpp_0 ) ( = hp_0 hpp_0 ) ( = countp_0 countpp_0 ) true ( = 1 countp_0 ) ) ) ( = xp_1 xpp_1 ) ( = hp_1 hpp_1 ) ( = countp_1 countpp_1 ) ) )
