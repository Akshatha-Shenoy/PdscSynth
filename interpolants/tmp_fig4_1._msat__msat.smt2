...
(define-fun A_1 () Bool  (and (or (and true (ite (= 1 h_1) (ite (= 0 count_1)                 (and (= xp_1 (- 42 x_1)) (= h_1 hp_1) (= countp_1 1))                 (and (= x_1 xp_1) (= h_1 hp_1) (= count_1 countp_1))) (ite (= count_1 0)                 (ite (= x_1 0)                      (and (= xp_1 42) (= h_1 hp_1) (= countp_1 1))                      (ite (= x_1 42) (and (= xp_1 0) (= h_1 hp_1) (= countp_1 1)) (and (= xp_1 0) (= h_1 hp_1) (= countp_1 1))))                 (and (= x_1 xp_1) (= h_1 hp_1) (= count_1 countp_1))))) (and (and (= x_1 xp_1) (= h_1 hp_1) (= count_1 countp_1)) true (= 1 count_1))) (= x_0 xp_0) (= h_0 hp_0) (= count_0 countp_0))) 
(define-fun A_2 () Bool   ( and ( or ( and true ( ite ( = 1 hp_0 ) ( ite ( = 0 countp_0 ) ( and ( = xpp_0 ( - 42 xp_0 ) ) ( = hp_0 hpp_0 ) ( = countpp_0 1 ) ) ( and ( = xp_0 xpp_0 ) ( = hp_0 hpp_0 ) ( = countp_0 countpp_0 ) ) ) ( ite ( = countp_0 0 ) ( ite ( = xp_0 0 ) ( and ( = xpp_0 42 ) ( = hp_0 hpp_0 ) ( = countpp_0 1 ) ) ( ite ( = xp_0 42 ) ( and ( = xpp_0 0 ) ( = hp_0 hpp_0 ) ( = countpp_0 1 ) ) ( and ( = xpp_0 0 ) ( = hp_0 hpp_0 ) ( = countpp_0 1 ) ) ) ) ( and ( = xp_0 xpp_0 ) ( = hp_0 hpp_0 ) ( = countp_0 countpp_0 ) ) ) ) ) ( and ( and ( = xp_0 xpp_0 ) ( = hp_0 hpp_0 ) ( = countp_0 countpp_0 ) ) true ( = 1 countp_0 ) ) ) ( = xp_1 xpp_1 ) ( = hp_1 hpp_1 ) ( = countp_1 countpp_1 ) ) )
