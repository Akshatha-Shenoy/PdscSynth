...
(define-fun A_6 () Bool   ( and ( or ( and true ( = hppppp_1 hpppppp_1 ) ( = xppppp_1 xpppppp_1 ) ( or ( and ( > zppppp_1 0 ) ( = 0 endpppppp_1 ) ( = 0 endppppp_1 ) ( = zpppppp_1 ( - zppppp_1 1 ) ) ( = ypppppp_1 ( + xppppp_1 yppppp_1 ) ) ) ( and ( <= zppppp_1 0 ) ( = 0 endppppp_1 ) ( = 1 endpppppp_1 ) ( = zpppppp_1 zppppp_1 ) ( = ypppppp_1 ( ite ( = 1 hppppp_1 ) yppppp_1 ( * 2 yppppp_1 ) ) ) ) ( and ( = zpppppp_1 zppppp_1 ) ( = 1 endppppp_1 ) ( = 1 endpppppp_1 ) ( = ypppppp_1 yppppp_1 ) ) ) ) ( and ( = zppppp_1 zpppppp_1 ) ( = yppppp_1 ypppppp_1 ) ( = xppppp_1 xpppppp_1 ) ( = hppppp_1 hpppppp_1 ) ( = endppppp_1 endpppppp_1 ) true ( = 1 endppppp_1 ) ) ) ( = zppppp_0 zpppppp_0 ) ( = yppppp_0 ypppppp_0 ) ( = xppppp_0 xpppppp_0 ) ( = hppppp_0 hpppppp_0 ) ( = endppppp_0 endpppppp_0 ) ) )
...
(define-fun A_8 () Bool   ( and ( or ( and true ( = hppppppp_0 hpppppppp_0 ) ( = xppppppp_0 xpppppppp_0 ) ( or ( and ( > zppppppp_0 0 ) ( = 0 endpppppppp_0 ) ( = 0 endppppppp_0 ) ( = zpppppppp_0 ( - zppppppp_0 1 ) ) ( = ypppppppp_0 ( + xppppppp_0 yppppppp_0 ) ) ) ( and ( <= zppppppp_0 0 ) ( = 0 endppppppp_0 ) ( = 1 endpppppppp_0 ) ( = zpppppppp_0 zppppppp_0 ) ( = ypppppppp_0 ( ite ( = 1 hppppppp_0 ) yppppppp_0 ( * 2 yppppppp_0 ) ) ) ) ( and ( = zpppppppp_0 zppppppp_0 ) ( = 1 endppppppp_0 ) ( = 1 endpppppppp_0 ) ( = ypppppppp_0 yppppppp_0 ) ) ) ) ( and ( = zppppppp_0 zpppppppp_0 ) ( = yppppppp_0 ypppppppp_0 ) ( = xppppppp_0 xpppppppp_0 ) ( = hppppppp_0 hpppppppp_0 ) ( = endppppppp_0 endpppppppp_0 ) true ( = 1 endppppppp_0 ) ) ) ( = zppppppp_1 zpppppppp_1 ) ( = yppppppp_1 ypppppppp_1 ) ( = xppppppp_1 xpppppppp_1 ) ( = hppppppp_1 hpppppppp_1 ) ( = endppppppp_1 endpppppppp_1 ) ) )
(define-fun A_9() Bool      ( and ( = zpppppppp_0 zpppppppp_1 ) ( not ( = ypppppppp_0 ypppppppp_1 ) ) ( = xpppppppp_0 xpppppppp_1 ) ( not ( <= xpppppppp_0 0 ) ) ( not ( = endpppppppp_1 0 ) ) ( not ( >= zpppppppp_1 2 ) ) ( not ( >= zpppppppp_0 1 ) ) ( not ( >= zpppppppp_1 1 ) ) ( not ( = endpppppppp_0 0 ) ) ( not ( = ( + ( * 2 xpppppppp_0 ) ( * 2 ypppppppp_0 ) ( * ( - 2 ) xpppppppp_1 ) ( * ( - 1 ) ypppppppp_1 ) ) 0 ) ) ( not ( = ( + xpppppppp_1 ypppppppp_1 ( * ( - 2 ) ypppppppp_0 ) ( * ( - 2 ) xpppppppp_0 ) ) 0 ) ) ( not ( <= ypppppppp_0 ypppppppp_1 ) ) ( not ( = ( + ypppppppp_1 ( * ( - 2 ) ypppppppp_0 ) ( * ( - 2 ) xpppppppp_0 ) ) 0 ) ) ( = ( + ( * 2 zpppppppp_0 ) ( * ( - 1 ) zpppppppp_1 ) ) 0 ) ( >= ypppppppp_0 0 ) ( >= zpppppppp_0 0 ) ( = endpppppppp_0 1 ) ( not ( = hpppppppp_0 1 ) ) ( >= ypppppppp_1 0 ) ( >= zpppppppp_1 0 ) ( = endpppppppp_1 1 ) ( = hpppppppp_1 1 ) ))
...
(assert ( ! A_9 :interpolation-group g9))
( check-sat )
( get-interpolant ( g0))
...
( get-interpolant ( g0 g1 g2 g3 g4 g5 g6 g7 g8))
(exit)