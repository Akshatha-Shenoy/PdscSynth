...
(define-fun A_5 () Bool   ( and ( or ( and true ( = hpppp_0 hppppp_0 ) ( = xpppp_0 xppppp_0 ) ( or ( and ( > zpppp_0 0 ) ( = 0 endppppp_0 ) ( = 0 endpppp_0 ) ( = zppppp_0 ( - zpppp_0 1 ) ) ( = yppppp_0 ( + xpppp_0 ypppp_0 ) ) ) ( and ( <= zpppp_0 0 ) ( = 0 endpppp_0 ) ( = 1 endppppp_0 ) ( = zppppp_0 zpppp_0 ) ( = yppppp_0 ( ite ( = 1 hpppp_0 ) ypppp_0 ( * 2 ypppp_0 ) ) ) ) ( and ( = zppppp_0 zpppp_0 ) ( = 1 endpppp_0 ) ( = 1 endppppp_0 ) ( = yppppp_0 ypppp_0 ) ) ) ) ( and ( = zpppp_0 zppppp_0 ) ( = ypppp_0 yppppp_0 ) ( = xpppp_0 xppppp_0 ) ( = hpppp_0 hppppp_0 ) ( = endpppp_0 endppppp_0 ) true ( = 1 endpppp_0 ) ) ) ( = zpppp_1 zppppp_1 ) ( = ypppp_1 yppppp_1 ) ( = xpppp_1 xppppp_1 ) ( = hpppp_1 hppppp_1 ) ( = endpppp_1 endppppp_1 ) ) )
...
(define-fun A_7() Bool      ( and ( = zpppppp_0 zpppppp_1 ) ( not ( = ypppppp_0 ypppppp_1 ) ) ( = xpppppp_0 xpppppp_1 ) ( not ( <= xpppppp_0 0 ) ) ( = zpppppp_1 ( * 2 zpppppp_0 ) ) ( not ( = zpppppp_1 ( + ( - 1 ) ( * 2 zpppppp_0 ) ) ) ) ( not ( = ypppppp_1 ( + ( * 2 ypppppp_0 ) xpppppp_0 ) ) ) ( >= ypppppp_0 0 ) ( >= zpppppp_0 0 ) ( = endpppppp_0 1 ) ( not ( = hpppppp_0 1 ) ) ( >= ypppppp_1 0 ) ( >= zpppppp_1 0 ) ( = endpppppp_1 1 ) ( = hpppppp_1 1 ) ))
