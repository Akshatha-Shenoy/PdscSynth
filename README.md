...
To individually run each benchmark from command prompt, follow the next section. To run all the benchmarks at once, follow the last section (https://github.com/Akshatha-Shenoy/PdscSynth#to-run-all-benchmarks-at-once-using-sygus-qe-and-msat).
