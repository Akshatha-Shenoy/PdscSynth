...
To individually run each benchmark from command prompt, follow the next section. To run all the benchmarks at once, see [here](#command-to-execute-a-benchmark).
