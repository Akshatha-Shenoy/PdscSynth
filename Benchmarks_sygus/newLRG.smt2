...
(declare-rel pred_0_synth_msat_1 (Int Int Int Int Int))
 (rule (=>  ( = 1  ( +  ( * 2 (rel lrg 1)  )  ( *  ( - 1  ) (rel x 1)  )  )  ) (pred_0_synth_msat_1 lrg y x h end)))
(declare-rel pred_0_synth_msat_2 (Int Int Int Int Int))
 (rule (=>  ( =  ( + (rel x 1)  ( *  ( - 2  ) (rel lrg 1)  )  )  ( - 2  )  ) (pred_0_synth_msat_2 lrg y x h end)))
(declare-rel pred_0_synth_msat_3 (Int Int Int Int Int))
 (rule (=>  ( = 3  ( +  ( * 4 (rel lrg 1)  )  ( *  ( - 1  ) (rel x 1)  )  )  ) (pred_0_synth_msat_3 lrg y x h end)))
(declare-rel pred_0_synth_msat_4 (Int Int Int Int Int))
 (rule (=>  ( =  ( + (rel x 1)  ( *  ( - 4  ) (rel lrg 1)  )  )  ( - 4  )  ) (pred_0_synth_msat_4 lrg y x h end)))
(declare-rel pred_synth_msat_5 (Int Int Int Int Int))
 (rule (=>  ( <=  ( + (rel x 1)  ( *  ( - 2  ) (rel lrg 1)  )  )  ( - 2  )  ) (pred_synth_msat_5 lrg y x h end)))
;(query End)
