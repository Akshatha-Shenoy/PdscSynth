...
(rule (=> (and (= 1 (rel i 0)) (= 2 (rel i 1))(= (rel n 0) (rel n 1))) (RelInit i n sum)))
(rule (=> (and (> n 0)(= sum 0) ) (Inv i n sum)))
...
; predicates
;stage 1- pre-post
(declare-rel i0_eq_1 (Int Int Int))
 (rule (=> (= 1 (rel i 0)) (i0_eq_1 i n sum)))
(declare-rel i1_eq_2 (Int Int Int))
 (rule (=> (= 2 (rel i 1)) (i1_eq_2 i n sum)))
