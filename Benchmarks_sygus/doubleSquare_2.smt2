...
(declare-rel p_synth_4 (Int Int Int Int Int))
 (rule (=>  (= (rel z 0) 4 ) (p_synth_4 z y x h end)))
(declare-rel p_synth_5 (Int Int Int Int Int))
 (rule (=>  (= (rel x 1) (rel x 1)) (p_synth_5 z y x h end)))
(declare-rel p_synth_6 (Int Int Int Int Int))
 (rule (=>  (= (rel z 0) 5 ) (p_synth_6 z y x h end)))
(declare-rel p_synth_7 (Int Int Int Int Int))
 (rule (=>  (= (rel z 0) 6 ) (p_synth_7 z y x h end)))
(declare-rel p_synth_8 (Int Int Int Int Int))
 (rule (=>  (= (rel z 0) 7 ) (p_synth_8 z y x h end)))
(declare-rel p_synth_9 (Int Int Int Int Int))
 (rule (=>  (= (rel z 0) 8 ) (p_synth_9 z y x h end)))
(declare-rel p_synth_10 (Int Int Int Int Int))
 (rule (=>  (= (rel h 1)  (- (rel z 0) 8 )) (p_synth_10 z y x h end)))
(declare-rel p_synth_11 (Int Int Int Int Int))
 (rule (=>  (= (rel z 0)  (* 2 5 )) (p_synth_11 z y x h end)))
(declare-rel p_synth_12 (Int Int Int Int Int))
 (rule (=>  (< (rel z 0)  (* 2 6 )) (p_synth_12 z y x h end)))
(declare-rel p_synth_13 (Int Int Int Int Int))
 (rule (=>  (< (rel x 1) (rel z 1)) (p_synth_13 z y x h end)))
(declare-rel p_synth_14 (Int Int Int Int Int))
 (rule (=>  (= (rel x 1) (rel z 0)) (p_synth_14 z y x h end)))
(declare-rel p_synth_15 (Int Int Int Int Int))
 (rule (=>  (= (rel y 0)  (- (rel y 1) (rel y 0))) (p_synth_15 z y x h end)))
(declare-rel p_synth_16 (Int Int Int Int Int))
 (rule (=>  (= (rel y 1)  (* 2  (+ (rel x 1) (rel y 0)))) (p_synth_16 z y x h end)))
(declare-rel p_synth_17 (Int Int Int Int Int))
 (rule (=>  (= (rel x 1)  (+ (rel y 0) (rel y 1))) (p_synth_17 z y x h end)))
(declare-rel p_synth_18 (Int Int Int Int Int))
 (rule (=>  (= (rel x 1) (rel y 1)) (p_synth_18 z y x h end)))
(query End)
